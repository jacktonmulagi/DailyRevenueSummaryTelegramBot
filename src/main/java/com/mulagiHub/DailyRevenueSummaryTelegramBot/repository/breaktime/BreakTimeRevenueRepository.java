...
import com.mulagiHub.DailyRevenueSummaryTelegramBot.models.breaktime.Revenue;
...
@Repository
public interface BreakTimeRevenueRepository extends JpaRepository<Revenue, Long> {
